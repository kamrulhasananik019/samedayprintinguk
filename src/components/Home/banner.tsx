...
const slides: Slide[] = [
  ...
  {
    image: '/banner/primeprint.webp',
    tag: 'Same Day Printing',
    headline: ['Same Day.', 'Any Print.', 'Every Time.'],
    sub: 'Order any time of the day, get it delivered to your door or ready to collect on the same day.',
    cta: 'Order Now, Get It Today',
    accent: '#0066FF',
    href: '/products',
  },
  {
    image: '/banner/prime.webp',
    tag: 'Big Format Printing',
    headline: ['Big Ideas', 'Deserve', 'Big Prints.'],
    sub: 'From A6 flyers to 10-metre banners, we print it all, same day, nationwide.',
