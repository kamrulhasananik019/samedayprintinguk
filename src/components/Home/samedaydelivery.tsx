        ...
        <div className="mb-10 flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
          ...
          <div className="flex items-center gap-3">
            <Link
              href="/products"
              prefetch={false}
              className="rounded-xl border border-stone-300 bg-white px-4 py-2 text-sm font-semibold text-stone-800 transition hover:bg-stone-900 hover:text-white"
            >
              View All Product
            </Link>
            <button
              ...
              className="hidden h-12 w-12 items-center justify-center rounded-full border border-stone-300 bg-white text-stone-900 transition-all duration-300 hover:bg-stone-900 hover:text-white md:flex"
            >
          ...
          <>
            ...
            <div className="mt-5 flex items-center justify-center gap-3 md:hidden">
              <button
                ...
                type="button"
                onClick={() => swiper?.slidePrev()}
                className="flex h-11 w-11 items-center justify-center rounded-full border border-stone-300 bg-white text-stone-900 transition-all duration-300 hover:bg-stone-900 hover:text-white"
              >
                <ChevronLeft className="h-5 w-5" />
              </button>
              <button
